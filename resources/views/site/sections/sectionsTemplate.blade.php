...
<section class="mt-5 wow fadeIn">
  <hr class="mb-4">
	@foreach($photo_sports as $photo_sport)
		<div class="mb-4"><img src="/images/sections/{{$photo_sport->photo_sport}}" class="img-fluid z-depth-1-half" alt=""></div>
		<div class="font-size-1rem">{!!$photo_sport->description!!}</div>
	@endforeach
</section>
